...
6. [writing-good-briefs.md](../../../dydo/guides/writing-good-briefs.md)
...
- **`project`** — chart the low-resolution Project route and Issue map with
  [project](.agents/skills/planner/resources/project.md).
- **`issue`** — sharpen one Issue just in time with [issue](.agents/skills/planner/resources/issue.md) until implementation
  is mechanical.
