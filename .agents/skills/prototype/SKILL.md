...
- **"Does this logic / state model feel right?"** → [logic](.agents/skills/prototype/resources/logic.md). Build a single
...
- **"What should this look like?"** → [ui](.agents/skills/prototype/resources/ui.md). Generate several radically different
