...
1. **Read the rubric you were given.** [code](.agents/skills/reviewer/resources/code.md) · [tests](.agents/skills/reviewer/resources/tests.md) ·
   [docs](.agents/skills/reviewer/resources/docs.md) · [project-plan](.agents/skills/reviewer/resources/project-plan.md) ·
   [issue-plan](.agents/skills/reviewer/resources/issue-plan.md) · [merge](.agents/skills/reviewer/resources/merge.md) — exactly the one the invoker
