...
4. **Write the plan at low resolution.** Follow [project](.claude/skills/planner/resources/project.md): destination, scope,
...
6. **Leave high resolution to just-in-time.** The [issue](.claude/skills/planner/resources/issue.md) plan is written into the
