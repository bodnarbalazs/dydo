...
- **`project`** — chart the low-resolution Project route and Issue map with
  [project](.claude/skills/planner/resources/project.md).
- **`issue`** — sharpen one Issue just in time with [issue](.claude/skills/planner/resources/issue.md) until implementation
  is mechanical.
