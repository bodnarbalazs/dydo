...
1. **Take the record.** Verify that it exists, belongs to its Captain, carries exactly
   ...
   serial ownership bound. Load [Bug](.claude/skills/specifier/resources/bug.md),
   [Merge](.claude/skills/specifier/resources/merge.md), or [Inquisition](.claude/skills/specifier/resources/inquisition.md) when that is the Type.
