...
- `MISSION.md`: A document capturing the _reason_ the human is interested in the topic. This should
  be used to ground all teaching. Use the format in [mission-format](.claude/skills/teach/resources/mission-format.md).
...
- `RESOURCES.md`: A list of resources which can be explored to ground your teaching in contextual
  ...
  [resources-format](.claude/skills/teach/resources/resources-format.md).
- `./learning-records/*.md`: A directory of learning records, which capture what the human has
  ...
  [learning-record-format](.claude/skills/teach/resources/learning-record-format.md).
...
in `./assets/` and link to it; never inline code a future lesson would duplicate.
...
Glossaries, in particular, are an essential reference. Once one is created, it should be adhered to in
every lesson. Use the format in [glossary-format](.claude/skills/teach/resources/glossary-format.md).
