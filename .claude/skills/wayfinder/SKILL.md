---
name: wayfinder
description: Explicitly invoked by the human to navigate an active Campaign whose route is too foggy to plan responsibly as one fixed Sprint. The methodology, standards, and checklist for working as a wayfinder.
---
