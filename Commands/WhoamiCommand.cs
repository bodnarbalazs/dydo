...
/// Session identity comes from the .session-context file written by the guard hook.
/// </summary>
public static class WhoamiCommand
{
    ...
    private static int Execute()
    {
        ...
        // Session context file is written by the guard hook before this command runs
