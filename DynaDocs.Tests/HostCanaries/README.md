...
not copy authentication or inherit API-key variables. Claude's live proof calls its configured model
provider. Run the complete gate only when the repository owner has approved that disclosure.
