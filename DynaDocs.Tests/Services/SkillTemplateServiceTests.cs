...
public class SkillTemplateServiceTests
{
    ...
    public void DiscoverSkills_EmitShapes_MatchTheNativePivot()
    {
        ...
        Assert.True(skills["specifier"].EmitAgent);
        Assert.True(skills["implementer"].EmitAgent);
        Assert.True(skills["hardener"].EmitAgent);
