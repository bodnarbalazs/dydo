...
**Note:** The setup will prompt you to set the `DYDO_HUMAN` environment variable. Agents use this to know who they belong to.
...
**Tip:** Direct an agent to dydo's repo to learn more about roles and have them create the role file.
