...
public interface IAgentRegistry
{
    ...
    /// <summary>
    /// Atomically sets the agent's resume-attempts counter to the cap AND clears
    /// LastResumeLaunchedAt. Both signals together encode "this resume episode is
    /// terminated, no more launches." Used by the watchdog's bad-session-ID fail-fast
    /// (#0152) and PR3's gave_up emission idempotency guard. Returns false if the
