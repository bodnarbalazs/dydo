...
public static class MessageService
{
    public static int Execute(string to, string body, string? subject, bool force)
    {
        ...
        // TryGetCurrentOwnedAgent decides ownership: it refuses a context the caller does not
        // own (blocking a hookless impersonator) while still allowing a genuine no-context
        // human to act anonymously.
