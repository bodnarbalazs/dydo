    ...
    public static List<RoleDefinition> GetBaseRoleDefinitions()
    {
        ...
        [
            ...
            new RoleDefinition
            {
                ...
                Base = true,
                WritablePaths = ["dydo/agents/{self}/**", "dydo/project/decisions/**", "dydo/project/issues/**"],
            ...
            new RoleDefinition
            {
                ...
                Base = true,
                WritablePaths = ["dydo/agents/{self}/**", "dydo/project/tasks/**", "dydo/project/decisions/**", "dydo/project/issues/**"],
                ReadOnlyPaths = ["**"],
            ...
            new RoleDefinition
            {
                ...
                Base = true,
                WritablePaths = ["dydo/agents/{self}/**", "dydo/project/issues/**", "dydo/project/inquisitions/**"],
                ReadOnlyPaths = ["{source}", "{tests}"],
