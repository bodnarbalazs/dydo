...
Uses the vocabulary in the `codebase-design` skill: **module**, **interface**, **seam**, **adapter**,
**leverage**.
...
Before spawning sub-agents, write a human-facing explanation of the problem space for the chosen
candidate:

- The constraints any new interface would need to satisfy
- The dependencies it would rely on, and which category they fall into (see
  [deepening](deepening.md))
...
Spawn 3+ sub-agents in parallel. Each must produce a **radically different** interface for the deepened
module.
