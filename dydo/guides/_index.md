...
- [Customizing Roles](./customizing-roles.md) - The skill template is the role: `dydo sync` discovers `skill-<name>.template.md` sources and compiles their methodology into native skills and,...
