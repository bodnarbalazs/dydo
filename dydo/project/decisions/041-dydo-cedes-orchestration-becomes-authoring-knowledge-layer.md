...
- **The switchboard problem.** dydo's own top-level dispatch model (long-lived codex agents in terminal tabs, claiming names from a 26-agent pool) turned the human into a switchboard operator: hand-nudging Brian, Charlie, Dexter all day because idle codex agents don't wake on message arrival ([#0279](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0279-codex-agents-do-not-receive-dydo-msg-in-real-time-durable-register-wait-register.md)). Meanwhile Claude **native subagents** (every reviewer/planner/simplifier) ran silently, flawlessly, needing no tab/claim/wake — and caught 5+ real bugs. The evidence pointed one way.
- **Every mechanism dydo built to fix this is machinery the platforms are removing the need for.** [#0279](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0279-codex-agents-do-not-receive-dydo-msg-in-real-time-durable-register-wait-register.md) (wake idle codex), [#0292](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0292-durable-wait-marker-silently-blinds-an-orchestrator-to-raise-hand-escalations-an.md) (durable-wait blindness), the whole codex app-server `turn/start` spike — all exist only because dydo chose long-lived sessions. Ephemeral run-to-completion workers make the entire class evaporate.
...
- **Vendor-coupled enforcement is brittle.** The guard's codex hook trust depends on an opaque per-entry hash dydo cannot compute ([#0296](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0296-dispatch-preflight-falsely-reports-the-codex-guard-as-trusted-active-when-codex.md)) — so dydo silently reported the guard "green" while codex had it switched off, and never actually matched codex's shell tool at all ([#0295](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0295-guard-never-sees-codex-shell-commands-pretooluse-matcher-lists-claude-tool-names.md)). Coordination/enforcement that dydo can't verify, dydo shouldn't own.
...
- The wake machinery: `dydo wait`, durable markers, the entire [#0279](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0279-codex-agents-do-not-receive-dydo-msg-in-real-time-durable-register-wait-register.md) codex app-server integration plan ([#0292](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0292-durable-wait-marker-silently-blinds-an-orchestrator-to-raise-hand-escalations-an.md) dies with it).
...
- Issues [#0279](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0279-codex-agents-do-not-receive-dydo-msg-in-real-time-durable-register-wait-register.md) (codex wake), [#0292](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0292-durable-wait-marker-silently-blinds-an-orchestrator-to-raise-hand-escalations-an.md) (wait blindness), [#0295](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0295-guard-never-sees-codex-shell-commands-pretooluse-matcher-lists-claude-tool-names.md) (guard shell hole), [#0296](https://github.com/bodnarbalazs/dydo/blob/ffffc02dcdf92b9677d0eb4f522d1af57a869990/dydo/project/issues/0296-dispatch-preflight-falsely-reports-the-codex-guard-as-trusted-active-when-codex.md) (preflight false-green) — the machinery this pivot makes moot or reframes.
