...
- [027 — Notion Token Storage: Project-Scoped, Local-Only Default + Opt-In Encrypted Vault](./027-notion-token-storage.md) - Per-user Notion token stored project-scoped; local-only default (gitignored `0600` + DPAPI) with an opt-in Argon2id-encrypted vault for repo-portability.
