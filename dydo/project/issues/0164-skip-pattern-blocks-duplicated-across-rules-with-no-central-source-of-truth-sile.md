...
Three sources of truth (FrontmatterRule/BrokenLinksRule/NamingRule share an identical skip block; HubGenerator.IsExcludedPath and FixHubHandler.IsExcludedFolder are separate lists; DocScanner has no exclusions) silently diverge over time. No live drift today once #0160 and #0163 are fixed; severity is low because the value is preventive, not remedial. Surfaced by inquisition dydo-check-drift.md finding #6.
