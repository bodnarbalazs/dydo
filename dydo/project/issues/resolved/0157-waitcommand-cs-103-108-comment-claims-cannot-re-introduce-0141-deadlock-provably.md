---
title: WaitCommand.cs:103-108 comment claims 'cannot re-introduce #0141 deadlock' — provably false under Decision 021
area: backend
fix-release: 
needs-human: false
resolution: 
...
## Resolution
Outdated: the disputed 'cannot re-introduce #0141 deadlock' comment was rewritten; WaitCommand.cs:121-129 now explains the registration-time snapshot invariant (cites #0141/#0147/#0149) and no longer makes the disproven claim. Triage sweep 2026-07-04 (Brian, CoS).