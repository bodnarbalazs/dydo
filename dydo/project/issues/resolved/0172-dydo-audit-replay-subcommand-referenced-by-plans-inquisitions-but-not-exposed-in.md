...
Outdated by the 2.0 pivot: the audit subsystem was torn down (dcf42c7); there is no dydo audit command for a replay subcommand to live under, and remaining references exist only in archived files. Triage sweep 2026-07-04 (Brian, CoS).