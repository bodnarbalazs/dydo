...
Fixed at HEAD: banner-gated-deletion regression test added covering auto-gen deletion and hand-written preservation (FixHubHandlerTests.cs:27,47-48). Triage sweep 2026-07-04 (Brian, CoS).