...
Fixed at HEAD: launchers stopped spawning the doomed re-arm wait, and a resumed session refreshes ClaimedPid/re-arms on its first guarded tool call via RefreshResumedAgentSession (GuardCommand.cs:225-232 '#0207 part 2'; verified in-code during this session). Goes live with the 2.0 install. Triage sweep 2026-07-04 (Brian, CoS).