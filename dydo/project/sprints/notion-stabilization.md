...
3. **The converter respects every Notion API hard limit** (100 blocks, 2-level nesting, 2000-char runs, 100 rich_texts per block) and phantom body conflicts from lossy round-trips are eliminated by canonical-render hashing.
