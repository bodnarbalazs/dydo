...
![Multi-agent orchestration with worktrees, inquisitors, and judges](../_assets/dydo_diagram_complex_workflow.svg)

Orchestrators dispatch agents with specific roles and tasks, monitor progress via `dydo wait`, and coordinate the feedback loop. Agents communicate through `dydo msg` and hand off work through the dispatch system.
