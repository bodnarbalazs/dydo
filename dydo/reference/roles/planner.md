...
- Can dispatch to **code-writer** to hand off the plan
...
If multi-agent coordination is needed, graduate to orchestrator ([H11](../guardrails.md)) rather than trying to coordinate multiple agents from the planner role.
