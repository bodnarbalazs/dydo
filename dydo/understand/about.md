...
- **Native skill authoring** — roles are plain `skills/<category>/<role>/` folders, edited directly
  and exposed FLAT through each host's discovery roots by `setup-skills.mjs`; there is no compile step.
