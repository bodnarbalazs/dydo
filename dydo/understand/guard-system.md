...
- **Plan-mode block**: `EnterPlanMode`/`ExitPlanMode` are blocked — planning happens through the Project Planner or Code Writer skill and plan records, not the platform's plan mode.
