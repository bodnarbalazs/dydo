...
- **Plan-mode block**: `EnterPlanMode`/`ExitPlanMode` are blocked — planning happens through the Project Planner or Specifier skill and plan records, not the platform's plan mode.
