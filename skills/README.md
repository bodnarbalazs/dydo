...
The 31 canonical dydo skills, sorted by kind:
...
- [`engineering/`](engineering/README.md) — 8 skills. The craft: diagnosing, shaping and designing
  code.
- [`productivity/`](productivity/README.md) — 14 skills. Thinking, writing, and moving work along
  with the human.

9 + 8 + 14 = 31, the full canonical set.
