...
The 31 canonical dydo skills live one level deeper than they used to, grouped by what kind of work
they do:
...
- [`engineering/`](engineering/README.md) — 12 skills. Writing, diagnosing, and shaping code and its
  design.
