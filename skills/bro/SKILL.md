...
glossary at `dydo/glossary.md` for domain terms and the locked dydo glossary at
`dydo/reference/dydo-glossary.md` for work-model terms. Resolve both paths from the repository root.
