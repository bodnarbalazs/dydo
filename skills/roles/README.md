...
- **code-writer** (model-invoked): A claimed Issue, no diff yet. Make its contract exact, drive it red before green inside its owned paths, then tighten it without changing behaviour.
