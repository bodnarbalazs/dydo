...
fog; each `issue-captain` makes its Issue exact through its compact acceptance contract.
...
If the target is an implementation Issue or lane, return it untouched and name `issue-captain`.
