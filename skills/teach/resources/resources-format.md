...
- **High-trust only.** Prefer primary sources, recognised experts, peer-reviewed work, and communities
...
- **Group by Knowledge / Wisdom.** Mirrors the philosophy in the `teach` skill. It is fine for a
  resource to appear in only one group.
